...
const SinglePostPage = () => {
  return (
    ...
    <div className="flex gap-8">   
      ...
      <h1 className='text-xl md:text-2xl xl:text-3xl 2xl:text-4xl font-semibold' >Lorem ipsum dolor sit amet consectetur, adipisicing elit.</h1>
      <div className="flex item-center gap-2 text-gray-400 text-sm">
      <span>written by</span>
      <Link className='text-blue-800'>Aditya Titu</Link>
      <span>on</span>
      <Link className='text-blue-800'>Web Design</Link>
      <span>2 days ago</span>
      </div>
      <p className='text-gray-500 font-medium'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur repellendus doloremque assumenda iure! Harum eaque aspernatur odio delectus quis facilis totam aliquam nesciunt iusto numquam, minima rem optio, id nobis.</p>
      </div>
      <div className="hidden lg:block w-2/5">
        <img className='rounded-2xl' src="postImg.jpeg" alt="" />
      </div>
    </div>
   ...
   <div className="flex flex-col md:flex-row gap-12 justify-between">
     ...
     {/* menu */}
     <div className="px-4 mt-6 h-max sticky top-8">
          <h1 className="mb-4 text-sm font-medium">Author</h1>
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-8">
             <img className='w-12 h-12 rounded-full object-cover' src="userImg.jpeg" alt="" />
              <Link className="text-blue-800">Aditya titu</Link>
            </div>
