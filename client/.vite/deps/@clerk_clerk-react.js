...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React14 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState4 = React14.useState, useEffect3 = React14.useEffect, useLayoutEffect2 = React14.useLayoutEffect, useDebugValue2 = React14.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var useAuth = (initialAuthState = {}) => {
  ...
  const [authState, setAuthState] = (0, import_react11.useState)(() => {
...
var Protect = ({ children, fallback, ...restAuthorizedParams }) => {
  ...
  const unauthorized = import_react19.default.createElement(import_react19.default.Fragment, null, fallback != null ? fallback : null);
  const authorized = import_react19.default.createElement(import_react19.default.Fragment, null, children);
  if (!userId) {
    return unauthorized;
  }
...
// node_modules/@clerk/shared/dist/chunk-KAQETGMA.mjs
...
// node_modules/@clerk/shared/dist/chunk-TEIBNOQP.mjs
...
var assertSingleChild = (children) => (name) => {
  try {
    return import_react24.default.Children.only(children);
  } catch (e) {
...
var normalizeWithDefaultValue = (children, defaultText) => {
  ...
  if (typeof children === "string") {
    children = import_react24.default.createElement("button", null, children);
  }
  return children;
};
...
function withMaxAllowedInstancesGuard(WrappedComponent, name, error) {
  ...
  const Hoc = (props) => {
    ...
    return import_react25.default.createElement(WrappedComponent, { ...props });
  };
...
var useCustomElementPortal = (elements) => {
  ...
  const [nodes, setNodes] = (0, import_react26.useState)(initialState);
  return elements.map((el, index) => ({
    ...
    portal: () => import_react26.default.createElement(import_react26.default.Fragment, null, nodes[index] ? (0, import_react_dom.createPortal)(el.component, nodes[index]) : null)
  }));
};
var isThatComponent = (v, component) => {
  return !!v && import_react28.default.isValidElement(v) && (v == null ? void 0 : v.type) === component;
};
...
var useCustomMenuItems = ({
  ...
  import_react29.default.Children.forEach(children, (child) => {
    ...
    const { props } = child;
    import_react29.default.Children.forEach(props.children, (child2) => {
...
var Portal = class extends import_react23.default.PureComponent {
  constructor() {
    super(...arguments);
    this.portalRef = import_react23.default.createRef();
  }
  ...
  render() {
    ...
    return import_react23.default.createElement(import_react23.default.Fragment, null, !hideRootHtmlElement && import_react23.default.createElement("div", { ref: this.portalRef }), this.props.children);
  }
};
var CustomPortalsRenderer = (props) => {
  var _a, _b;
  return import_react23.default.createElement(import_react23.default.Fragment, null, (_a = props == null ? void 0 : props.customPagesPortals) == null ? void 0 : _a.map((portal, index) => (0, import_react23.createElement)(portal, { key: index })), (_b = props == null ? void 0 : props.customMenuItemsPortals) == null ? void 0 : _b.map((portal, index) => (0, import_react23.createElement)(portal, { key: index })));
};
...
var _UserProfile = withClerk(
  ({ clerk, ...props }) => {
    ...
    return import_react23.default.createElement(
      ...
      import_react23.default.createElement(CustomPortalsRenderer, { customPagesPortals })
    );
  },
  "UserProfile"
);
...
var UserButtonContext = (0, import_react23.createContext)({
  mount: () => {
  },
  unmount: () => {
  },
...
var _UserButton = withClerk(
  ({ clerk, ...props }) => {
    ...
    return import_react23.default.createElement(UserButtonContext.Provider, { value: passableProps }, import_react23.default.createElement(
      Portal,
      {
        ...passableProps,
      ...
      import_react23.default.createElement(CustomPortalsRenderer, { ...portalProps })
    ));
  },
  "UserButton"
);
...
function UserButtonOutlet(outletProps) {
  const providerProps = (0, import_react23.useContext)(UserButtonContext);
  const portalProps = {
    ...providerProps,
    props: {
      ...providerProps.props,
  ...
  return import_react23.default.createElement(Portal, { ...portalProps });
}
...
var OrganizationSwitcherContext = (0, import_react23.createContext)({
  mount: () => {
  },
  unmount: () => {
  },
...
var _OrganizationSwitcher = withClerk(
  ({ clerk, ...props }) => {
    ...
    return import_react23.default.createElement(OrganizationSwitcherContext.Provider, { value: passableProps }, import_react23.default.createElement(
      Portal,
      {
        ...passableProps,
        hideRootHtmlElement: !!props.__experimental_asProvider
...
function OrganizationSwitcherOutlet(outletProps) {
  const providerProps = (0, import_react23.useContext)(OrganizationSwitcherContext);
  const portalProps = {
    ...providerProps,
    props: {
      ...providerProps.props,
...
function ClerkContextProvider(props) {
  ...
  const [state, setState] = import_react36.default.useState({
    client: clerk.client,
  ...
  const clerkCtx = import_react36.default.useMemo(() => ({ value: clerk }), [clerkLoaded2]);
  const clientCtx = import_react36.default.useMemo(() => ({ value: state.client }), [state.client]);
  const {
    sessionId,
    session,
    userId,
  ...
  const authCtx = import_react36.default.useMemo(() => {
    const value = {
      sessionId,
      userId,
      actor,
  ...
  const sessionCtx = import_react36.default.useMemo(() => ({ value: session }), [sessionId, session]);
  const userCtx = import_react36.default.useMemo(() => ({ value: user }), [userId, user]);
  const organizationCtx = import_react36.default.useMemo(() => {
    const value = {
      organization
    };
    return { value };
  ...
  return (
    ...
    import_react36.default.createElement(IsomorphicClerkContext.Provider, { value: clerkCtx }, import_react36.default.createElement(ClientContext.Provider, { value: clientCtx }, import_react36.default.createElement(SessionContext.Provider, { value: sessionCtx }, import_react36.default.createElement(OrganizationProvider, { ...organizationCtx.value }, import_react36.default.createElement(AuthContext.Provider, { value: authCtx }, import_react36.default.createElement(UserContext.Provider, { value: userCtx }, children))))))
  );
}
var useLoadedIsomorphicClerk = (options) => {
  const [loaded, setLoaded] = import_react36.default.useState(false);
  const isomorphicClerk = import_react36.default.useMemo(() => IsomorphicClerk.getOrCreateInstance(options), []);
  import_react36.default.useEffect(() => {
